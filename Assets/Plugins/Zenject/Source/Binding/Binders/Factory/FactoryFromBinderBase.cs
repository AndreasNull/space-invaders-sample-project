...
namespace Zenject
{
    ...
    public class FactoryFromBinderBase : ScopeConcreteIdArgConditionCopyNonLazyBinder
    {
        ...
        /// <summary>
        /// Custom method to support AGames.AssetManagment.AssetManager (Andreas Diktyopoulos)
        /// </summary>
        /// <param name="path"></param>
        /// <returns></returns>
        public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder FromAssetManager(string path)
        {
            var gameObjectInfo = new GameObjectCreationParameters();
